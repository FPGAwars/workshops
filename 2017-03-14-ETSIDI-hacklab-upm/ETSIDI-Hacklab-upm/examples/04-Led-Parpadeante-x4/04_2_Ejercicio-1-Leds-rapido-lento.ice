{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c0f82b4b-1c53-48a4-a8e5-1e0aae36be93",
        ...
        {
          "id": "3d8329a3-2a1c-4a9a-ac42-99135d9d4678",
        ...
        {
          "id": "86585f0d-7547-4f0b-89cf-2f4019ce9c3a",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "eed394e1-023f-4f89-a92a-a093f382695b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "9babc6ba-4e06-4be1-96e0-7fa6b4cc2694",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "a53d6dcd-5543-4cc0-9e40-ddb55eb3b685",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "b5ec321b-d3a4-4c22-8ebf-0164b5f96bde",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "c29ba8c4-cc08-455e-a972-ca0e0490c290",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "9f9f8b01-c7b1-44f9-b456-c57bdb1ec3a6",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "46a4c770-457d-4b1f-bf52-676332d86375",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "1de5720e-3410-4e64-a34f-a36156ddc0f5",
          "type": "basic.info",
          "data": {
            "info": "Ejercicio 4.1: Parpadeo a diferentes velocidades\n\nEste circuito utiliza dos bombas de bits de diferentes velocidades, cada una\nconectada a 4 leds, para que parpadeen a distintas velocidades. Los 4 leds\nde menor peso (led0, led1, led2 y led3) parpadean 4 veces por segundo, \nmientras que los 4 de mayor peso (led4, led5, led6 y led7) lo hacen 1 vez\npor segundo"
          },
          "position": {
            "x": 40,
            "y": 440
      ...
      "wires": [
        {
          "source": {
            "block": "3d8329a3-2a1c-4a9a-ac42-99135d9d4678",
            "port": "7e07d449-6475-4839-b43e-8aead8be2aac"
          },
          "target": {
            "block": "86585f0d-7547-4f0b-89cf-2f4019ce9c3a",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "9babc6ba-4e06-4be1-96e0-7fa6b4cc2694",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "b5ec321b-d3a4-4c22-8ebf-0164b5f96bde",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "9f9f8b01-c7b1-44f9-b456-c57bdb1ec3a6",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "c0f82b4b-1c53-48a4-a8e5-1e0aae36be93",
            "port": "7e07d449-6475-4839-b43e-8aead8be2aac"
          },
          "target": {
            "block": "eed394e1-023f-4f89-a92a-a093f382695b",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "a53d6dcd-5543-4cc0-9e40-ddb55eb3b685",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "c29ba8c4-cc08-455e-a972-ca0e0490c290",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "46a4c770-457d-4b1f-bf52-676332d86375",
            "port": "in"
          }
        }
      ]

{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "903f48bc-8494-4fd6-979a-488626c57b82",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "8b1580bd-8ff8-4c96-aa0e-0c10f27740ac",
          "type": "basic.input",
          "data": {
            "name": "IR",
            "pins": [
        ...
        {
          "id": "aa3dbec5-2b9a-415c-b353-fc3d9516faa7",
          "type": "basic.input",
          "data": {
            "name": "IR",
            "pins": [
        ...
        {
          "id": "82e5d058-1957-4a15-a991-07b299172049",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "a935d528-0de0-4711-90c7-001c2e6dc7b6",
        ...
        {
          "id": "62ce091e-b029-4c75-93d6-a6b83dd55b0a",
          "type": "basic.info",
          "data": {
            "info": "Ejemplo de una barrera de acceso de vehículos  un recinto\nAl llegar el vehículo lo detecta el sensor de infrarrojos\ny se abre la barrera. Cuando el segundo IR detecta que ya ha\npasado la barrera, la cierra",
            "readonly": true
          },
          "position": {
            "x": 240,
        ...
        {
          "id": "b7ea2bdb-580b-4f8b-9b76-760a456a0403",
          "type": "basic.info",
          "data": {
            "info": "Debug: mostrar en un led el \nestado de la barrera",
            "readonly": true
          },
          "position": {
            "x": 440,
        ...
        {
          "id": "64a9b4f0-a617-4806-b39f-6afb4906c3c0",
      ...
      "wires": [
        {
          "source": {
            "block": "a935d528-0de0-4711-90c7-001c2e6dc7b6",
            "port": "57be7e63-0883-4185-b37b-f150b319c7c7"
          },
          "target": {
            "block": "903f48bc-8494-4fd6-979a-488626c57b82",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "8b1580bd-8ff8-4c96-aa0e-0c10f27740ac",
            "port": "out"
          },
          "target": {
            "block": "64a9b4f0-a617-4806-b39f-6afb4906c3c0",
        ...
        {
          "source": {
            "block": "aa3dbec5-2b9a-415c-b353-fc3d9516faa7",
            "port": "out"
          },
          "target": {
            "block": "64a9b4f0-a617-4806-b39f-6afb4906c3c0",
        ...
        },
        {
          ...
          "target": {
            "block": "82e5d058-1957-4a15-a991-07b299172049",
            "port": "in"
          }
        }
      ]

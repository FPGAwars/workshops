{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "61d39973-d8e2-4368-b897-be7f25a378f9",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "55586e9c-d1bf-4ea1-af2a-efd73e0e39a1",
          "type": "basic.constant",
          "data": {
            "name": "TICS",
            "value": "100",
        ...
        {
          "id": "2b1dcfc8-c238-4522-940b-5bfb1992b0f2",
        ...
        {
          "id": "20820743-9acd-4f3b-afdd-0530aa726a64",
        ...
        {
          "id": "217309a6-9173-4b43-bc37-b8f870424b7a",
          "type": "basic.info",
          "data": {
            "info": "Ejemplo de posicionamiento de un servo Futaba 3003\n\nSe genera un pulso periódico (periodo 20ms) y de anchura\nigual a 100 tics (1000 micro-segundos = 1ms)\n",
            "readonly": true
          },
          "position": {
            "x": 112,
        ...
        {
          "id": "c8ed13d6-ff55-478f-96b5-23fd58bb0557",
          "type": "basic.info",
          "data": {
            "info": "Cambiando los valores del parámetro TICS\nentre 40 y 240 se posiciona el servo \nen todo su rango",
            "readonly": true
          },
          "position": {
            "x": 232,
      ...
      "wires": [
        {
          "source": {
            "block": "55586e9c-d1bf-4ea1-af2a-efd73e0e39a1",
            "port": "constant-out"
          },
          "target": {
            "block": "2b1dcfc8-c238-4522-940b-5bfb1992b0f2",
        ...
        {
          "source": {
            "block": "20820743-9acd-4f3b-afdd-0530aa726a64",
            "port": "b5d4dc7d-6aef-4e7c-90dc-8ca65d0db5d7"
          },
          "target": {
            "block": "61d39973-d8e2-4368-b897-be7f25a378f9",
            "port": "in"
          }
        },
        {

{
  "version": "1.1",
  "package": {
    "name": "Mux 2 a 1 (2bits)",
    "version": "0.0.1",
    "description": "Multiplexor de 2 a 1 de buses de 2 bits. Implementación en Verilog",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "09b98fd9-cc49-464e-9706-b12c4057f0a5",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[1:0]",
        ...
        {
          "id": "b3bf1ec4-09bb-46b1-a142-575714fc530f",
          "type": "basic.input",
          "data": {
            "name": "i1",
            "range": "[1:0]",
        ...
        {
          "id": "02bc6221-b439-47a9-9d6f-3ad134b642ca",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[1:0]",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "b3bf1ec4-09bb-46b1-a142-575714fc530f",
            "port": "out"
          },
          "target": {
            "block": "34e6d77b-15a8-4b7c-8c41-09e9b8d4d2be",
        ...
        {
          "source": {
            "block": "09b98fd9-cc49-464e-9706-b12c4057f0a5",
            "port": "out"
          },
          "target": {
            "block": "34e6d77b-15a8-4b7c-8c41-09e9b8d4d2be",
        ...
        },
        {
          ...
          "target": {
            "block": "02bc6221-b439-47a9-9d6f-3ad134b642ca",
            "port": "in"
          },
          "size": 2
        }

{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "15aaabc6-551c-445f-9182-f3823ffa2813",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "8a00e1b6-c816-4cd9-8446-79b054644440",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "6c9065bb-203a-4aed-88a0-f135125efd41",
        ...
        {
          "id": "bbd2d938-33d1-4094-bf62-69a7cf106262",
          "type": "basic.info",
          "data": {
            "info": "Prueba del Servobit90 para Servos Futaba 3003 o compatibles",
            "readonly": true
          },
          "position": {
            "x": 224,
      ...
      "wires": [
        {
          "source": {
            "block": "6c9065bb-203a-4aed-88a0-f135125efd41",
            "port": "57be7e63-0883-4185-b37b-f150b319c7c7"
          },
          "target": {
            "block": "15aaabc6-551c-445f-9182-f3823ffa2813",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "8a00e1b6-c816-4cd9-8446-79b054644440",
            "port": "out"
          },
          "target": {
            "block": "6c9065bb-203a-4aed-88a0-f135125efd41",

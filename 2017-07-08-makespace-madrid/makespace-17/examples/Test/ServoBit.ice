{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "1631c7ac-146d-4dc3-9357-d97dd8d3f3ad",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "1129a629-2d74-495c-812d-4119f2220221",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "a00f143e-e3f4-439f-ace5-cbf3b8afb194",
          "type": "basic.constant",
          "data": {
            "name": "POS0",
            "value": "82",
        ...
        {
          "id": "8ce40e94-b18b-4f40-9954-85c72273ed5b",
          "type": "basic.constant",
          "data": {
            "name": "POS1",
            "value": "170",
        ...
        {
          "id": "5dcd79db-57e5-4b05-8768-59c83df6d40f",
        ...
        {
          "id": "91a6e29d-48d0-420b-8de7-4cd412467650",
          "type": "basic.info",
          "data": {
            "info": "Ejemplo de uso del bloque ServoBit\nEl servo está en la posicion 0. Al apretar el pulsador se mueve\na la 1. Al soltarlo vuelve a la 0",
            "readonly": true
          },
          "position": {
            "x": 216,
        ...
        {
          "id": "5dabd80d-b636-46c8-8250-042f177d3c87",
          "type": "basic.info",
          "data": {
            "info": "Las posiciones correspondientes a 0 y 1 se establecen con los \nparametros POS0 y POS1, indicando el valor en unidades de \n10 micro-segundos",
            "readonly": true
          },
          "position": {
            "x": 208,
      ...
      "wires": [
        {
          "source": {
            "block": "5dcd79db-57e5-4b05-8768-59c83df6d40f",
            "port": "d12e0304-1458-4f1a-8ec9-5603ba9997c3"
          },
          "target": {
            "block": "1631c7ac-146d-4dc3-9357-d97dd8d3f3ad",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "1129a629-2d74-495c-812d-4119f2220221",
            "port": "out"
          },
          "target": {
            "block": "5dcd79db-57e5-4b05-8768-59c83df6d40f",
        ...
        {
          "source": {
            "block": "a00f143e-e3f4-439f-ace5-cbf3b8afb194",
            "port": "constant-out"
          },
          "target": {
            "block": "5dcd79db-57e5-4b05-8768-59c83df6d40f",
        ...
        {
          "source": {
            "block": "8ce40e94-b18b-4f40-9954-85c72273ed5b",
            "port": "constant-out"
          },
          "target": {
            "block": "5dcd79db-57e5-4b05-8768-59c83df6d40f",

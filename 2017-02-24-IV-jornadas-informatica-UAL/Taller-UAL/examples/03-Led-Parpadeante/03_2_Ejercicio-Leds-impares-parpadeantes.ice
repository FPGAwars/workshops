{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "4f0a308f-49cc-4baf-9ced-c8cccf68c840",
        ...
        {
          "id": "86b7be41-238a-48c7-9aa7-2d8c0ecada87",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "7aa0837b-d433-4f0e-9292-3ac1a09df514",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "7f84f1bf-b250-4ffc-8517-458505c64039",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "ccfe1028-0f6d-4600-bddf-5a2a79788afb",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "d450a886-8d69-435e-84b4-29de93a68860",
          "type": "basic.info",
          "data": {
            "info": "Ejercicio 3.1: Leds impares parpadeantes\n\nEste circuito hace que parpadeen todos los leds impares de la \nIcezum Alhambra a la vez: led1, led3, led5 y led7, a un ritmo de \nuna vez por segundo"
          },
          "position": {
            "x": 72,
            "y": 384
      ...
      "wires": [
        {
          "source": {
            "block": "4f0a308f-49cc-4baf-9ced-c8cccf68c840",
            "port": "7e07d449-6475-4839-b43e-8aead8be2aac"
          },
          "target": {
            "block": "86b7be41-238a-48c7-9aa7-2d8c0ecada87",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "7aa0837b-d433-4f0e-9292-3ac1a09df514",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "7f84f1bf-b250-4ffc-8517-458505c64039",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "ccfe1028-0f6d-4600-bddf-5a2a79788afb",
            "port": "in"
          }
        }
      ]

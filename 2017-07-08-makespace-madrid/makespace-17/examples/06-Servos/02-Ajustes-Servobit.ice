{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "4b5a917e-8a94-45e3-86cd-e8773aba2c78",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "95a4fc80-7d44-465d-93dc-c05a1566f4f7",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "27c1bf73-9a4a-4e7a-896b-7c1606e036f1",
          "type": "basic.constant",
          "data": {
            "name": "P0",
            "value": "104",
        ...
        {
          "id": "7ba47d8e-9264-45ea-812b-98ff4914a9e4",
          "type": "basic.constant",
          "data": {
            "name": "P1",
            "value": "148",
        ...
        {
          "id": "d6756b99-fec5-4308-879d-7bae84e4c0ef",
        ...
        {
          "id": "f878ceb3-0fe6-46b6-a4c1-a6a9bbcfb6f8",
          "type": "basic.info",
          "data": {
            "info": "Ejemplo de ajuste de un ServoBit para que se mueva un ángulo diferente, o\npara adaptarlo a otros servos",
            "readonly": true
          },
          "position": {
            "x": 144,
      ...
      "wires": [
        {
          "source": {
            "block": "27c1bf73-9a4a-4e7a-896b-7c1606e036f1",
            "port": "constant-out"
          },
          "target": {
            "block": "d6756b99-fec5-4308-879d-7bae84e4c0ef",
        ...
        {
          "source": {
            "block": "7ba47d8e-9264-45ea-812b-98ff4914a9e4",
            "port": "constant-out"
          },
          "target": {
            "block": "d6756b99-fec5-4308-879d-7bae84e4c0ef",
        ...
        },
        {
          ...
          "target": {
            "block": "4b5a917e-8a94-45e3-86cd-e8773aba2c78",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "95a4fc80-7d44-465d-93dc-c05a1566f4f7",
            "port": "out"
          },
          "target": {
            "block": "d6756b99-fec5-4308-879d-7bae84e4c0ef",

{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "f14182d0-51a1-4110-b0dc-6d2261c43f5f",
        ...
        {
          "id": "3746152a-ff75-4689-81f7-eeedbf331b99",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 12.1: Parpadeo del led a dos velocidades\n\nSe utilizan dos señales de reloj para hacer parpadear un led a dos\nvelocidades distintas, según el estado de un botón de cambio accionado\npor el pulsador SW1. Inicialmente el multiplexor selecciona la señal\nde 1 segundo, que es la que se envía a led 7 para parpadear. Al hacer\nun click en SW1, el botón de cambio pasa a 1 y el multiplexor selecciona\nla señal rápida, que le entra por su canal 1. Si volvemos a hacer\nclick se selecciona de nuevo la señal lenta de 1 segundo\n\n"
          },
          "position": {
            "x": 48,
            "y": 264
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "f14182d0-51a1-4110-b0dc-6d2261c43f5f",
        ...
        {
          "source": {
            "block": "3746152a-ff75-4689-81f7-eeedbf331b99",
            "port": "7e07d449-6475-4839-b43e-8aead8be2aac"
          },
          "target": {
            "block": "8563e21b-09f5-4128-876a-aa2adaa5caa6",
